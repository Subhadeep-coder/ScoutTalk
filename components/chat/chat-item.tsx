                                            ...
                                            <FormItem className='flex-1'>
                                                <FormControl>
                                                    <div className="relative w-full">
                                                        <Input
                                                            disabled={isLoading}
                                                            className='p-2 bg-zinc-200/90 border-none border-0 dark:bg-zinc-700/75 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200'
                            ...
                            canEditMessage && (
                                <ActionTooltip label='Edit'>
                                    <Edit
                                        ...
                                        className='h-4 w-4 ml-auto cursor-pointer transition text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300'
                                    />
                                </ActionTooltip>
                            )
                        }
