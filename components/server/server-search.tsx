...
import { ServerSearchItem } from '@/types';
    ...
    return (
        <>
            ...
            >
                ...
                <kbd
                    className='pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted font-mono ml-auto px-1.5 text-[10px] font-medium text-muted-foreground'
                >
